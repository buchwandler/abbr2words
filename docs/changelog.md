...
## [v0.2.15] - 2026-09-14
### Added
- Added German IP, IP-Adresse, LTS, and century abbreviation expansions
...
- Added German currency aliases, Spanish dong and tugrik identities, and locale-aware grouped-number handling
...
- Added reviewed German abbreviations for gemäß and Abteilung
- Added isolated custom abbreviation APIs with explicit spoken forms and atomic bulk conflict reporting
- Added reviewed German lexical abbreviations including vgl., i.d.R., o.ä., and u.U. coverage
